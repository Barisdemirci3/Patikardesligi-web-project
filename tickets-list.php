      ...
      <?php switch ($writedata["ticket_durum"]) {
        ...
        case 1:
         ?>  <td><span class="badge" style="background-color: #F1C306;">Cevap verildi, yanıt bekleniyor</span></td> <?php
          break; case 2:?> <td><span class="badge" style="background-color: green;">Ticket sonuçlandı</span></td> <?php break; }?>
      
       <td><button type="button" class="btn btn-info btn-sm" title="Ticket'i incele"><i class="far fa-edit"></i></button></td>
    </tr>
   <?php } ?>
